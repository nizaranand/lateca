...
<script type="text/javascript">
	...
	jQuery(window).load(function() {
	        jQuery('#slider').nivoSlider({
	                ...
	                startSlide: 0, // start on slide 0 - keep static for now (perhaps add random option later)
...
<div id="slider">
<?php
	query_posts('cat='.get_option('snivo_category'));
